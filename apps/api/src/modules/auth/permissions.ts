...
export const PERMISSIONS = {
	...
	complaint: ["read", "create", "mediate", "close", "refer_external", "generate_referral_letter", "list"],
	ticket: ["read", "create", "assign", "resolve", "close", "list"],
...
const staffPermissions: Record<WezStaffRole, ReadonlyArray<Permission>> = {
	...
	compliance_officer: [
		...
		"complaint:generate_referral_letter",
		"ticket:create",
		"ticket:read",
		"ticket:list",
		"ticket:resolve",
