...
const seed = async () => {
	...
	const sampleWorkers = [
		{ fullName: "Yonas Alemu", fayda: "F-2345-6789-CD", phone: "+251911223300", gender: "M", area: "bole", languages: ["am", "en"], experienceYears: 5, hasHealthCard: false, hasPoliceClearance: true, roles: ["driver"], agentId: agentBole.id, stationId: stationBole.id, bio: "Experienced driver, knows Addis well.", tier: "verified", ratingAverage: 4.6 },
		{ fullName: "Marta Tadesse", fayda: "F-3456-7890-EF", phone: "+251911334411", gender: "F", area: "bole", languages: ["am"], experienceYears: 3, hasHealthCard: true, hasPoliceClearance: false, roles: ["house_maid"], agentId: agentBole.id, stationId: stationBole.id, bio: "Reliable household support with recent references.", tier: "basic", ratingAverage: 4.2 },
		{ fullName: "Dawit Mekonnen", fayda: "F-4567-8901-GH", phone: "+251911445522", gender: "M", area: "megenagna", languages: ["am", "om"], experienceYears: 7, hasHealthCard: false, hasPoliceClearance: true, roles: ["guard"], agentId: agentMegenagna.id, stationId: stationMegenagna.id, bio: "Night shift guard, ex-military.", tier: "verified", ratingAverage: 4.7 },
		{ fullName: "Hanna Lemma", fayda: "F-5678-9012-IJ", phone: "+251911556633", gender: "F", area: "bole", languages: ["am", "en"], experienceYears: 4, hasHealthCard: true, hasPoliceClearance: false, roles: ["nanny"], agentId: agentBole.id, stationId: stationBole.id, bio: "Warm with children, references available.", tier: "basic", ratingAverage: 4.4 },
		{ fullName: "Tariku Bekele", fayda: "F-6789-0123-KL", phone: "+251911667744", gender: "M", area: "megenagna", languages: ["am", "en"], experienceYears: 2, hasHealthCard: true, hasPoliceClearance: false, roles: ["waiter"], agentId: agentMegenagna.id, stationId: stationMegenagna.id, bio: "Fast learner for hospitality shifts.", tier: "basic", ratingAverage: 4.0 },
		{ fullName: "Bethel Girma", fayda: "F-7890-1234-MN", phone: "+251911778855", gender: "F", area: "bole", languages: ["am", "ti"], experienceYears: 6, hasHealthCard: true, hasPoliceClearance: true, roles: ["cook"], agentId: agentBole.id, stationId: stationBole.id, bio: "Cooks Ethiopian and Italian meals.", tier: "trusted", ratingAverage: 4.9 },
		{ fullName: "Solomon Worku", fayda: "F-8901-2345-OP", phone: "+251911889966", gender: "M", area: "kazanchis", languages: ["am"], experienceYears: 1, hasHealthCard: false, hasPoliceClearance: false, roles: ["cleaner"], agentId: agentBole.id, stationId: stationBole.id, bio: "Available for offices and compounds.", tier: "basic", ratingAverage: null },
		{ fullName: "Selam Desta", fayda: "F-9012-3456-QR", phone: "+251911990077", gender: "F", area: "megenagna", languages: ["am", "en"], experienceYears: 3, hasHealthCard: true, hasPoliceClearance: false, roles: ["barista"], agentId: agentMegenagna.id, stationId: stationMegenagna.id, bio: "Latte art, espresso machine certified.", tier: "trained", ratingAverage: 4.5 },
		{ fullName: "Henok Fikru", fayda: "F-0123-4567-ST", phone: "+251912001188", gender: "M", area: "mexico", languages: ["am", "ar"], experienceYears: 8, hasHealthCard: false, hasPoliceClearance: true, roles: ["driver"], agentId: agentBole.id, stationId: stationBole.id, bio: "Long-haul and delivery experience.", tier: "verified", ratingAverage: 4.3 },
		{ fullName: "Tigist Kebede", fayda: "F-1230-4560-UV", phone: "+251912112299", gender: "F", area: "megenagna", languages: ["am"], experienceYears: 2, hasHealthCard: true, hasPoliceClearance: false, roles: ["house_maid", "cleaner"], agentId: agentMegenagna.id, stationId: stationMegenagna.id, bio: "Flexible household and cleaning work.", tier: "basic", ratingAverage: 4.1 },
		{ fullName: "Mekonnen Zeleke", fayda: "F-2340-5670-WX", phone: "+251912223300", gender: "M", area: "megenagna", languages: ["am", "ti"], experienceYears: 10, hasHealthCard: false, hasPoliceClearance: true, roles: ["guard"], agentId: agentMegenagna.id, stationId: stationMegenagna.id, bio: "Senior guard, day and night shifts.", tier: "trusted", ratingAverage: 4.8 },
		{ fullName: "Rahel Assefa", fayda: "F-3450-6780-YZ", phone: "+251912334411", gender: "F", area: "summit", languages: ["am", "en"], experienceYears: 5, hasHealthCard: true, hasPoliceClearance: true, roles: ["cook", "nanny"], agentId: agentBole.id, stationId: stationBole.id, bio: "Experienced family cook and childcare helper.", tier: "trained", ratingAverage: 4.6 },
		{ fullName: "Abel Seyoum", fayda: "F-4560-7890-AB", phone: "+251912445522", gender: "M", area: "megenagna", languages: ["am", "en", "om"], experienceYears: 3, hasHealthCard: true, hasPoliceClearance: false, roles: ["waiter", "barista"], agentId: agentMegenagna.id, stationId: stationMegenagna.id, bio: "Hospitality graduate.", tier: "trained", ratingAverage: 4.4 },
		{ fullName: "Genet Tola", fayda: "F-5670-8900-CD", phone: "+251912556633", gender: "F", area: "kirkos", languages: ["am"], experienceYears: 4, hasHealthCard: false, hasPoliceClearance: false, roles: ["cleaner"], agentId: agentBole.id, stationId: stationBole.id, bio: "Office and post-construction cleaning.", tier: "basic", ratingAverage: 4.0 },
		{ fullName: "Mulugeta Berhanu", fayda: "F-6780-9010-EF", phone: "+251912667744", gender: "M", area: "bole", languages: ["am", "en"], experienceYears: 2, hasHealthCard: true, hasPoliceClearance: false, roles: ["barista", "waiter"], agentId: agentBole.id, stationId: stationBole.id, bio: "Cafe and restaurant floor work.", tier: "basic", ratingAverage: 4.2 },
		{ fullName: "Helen Wondimu", fayda: "F-8900-1230-IJ", phone: "+251912889966", gender: "F", area: "megenagna", languages: ["am", "en"], experienceYears: 7, hasHealthCard: true, hasPoliceClearance: true, roles: ["nanny"], agentId: agentMegenagna.id, stationId: stationMegenagna.id, bio: "Strong references for childcare.", tier: "trusted", ratingAverage: 4.9 },
	] as const;
